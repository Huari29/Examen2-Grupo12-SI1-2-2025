<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar Materia</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Modifica los datos de la materia</p>
        </div>
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
        <div class="p-6">
            <form wire:submit="update" class="space-y-6">
                ...
                <!-- Carga Horaria y Gestión (Grid) -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Carga Horaria -->
                    <div>
                        <label for="carga_horaria" class="block text-sm font-medium mb-2 text-gray-900 dark:text-white">
                            Carga Horaria (horas) <span class="text-red-500">*</span>
                        </label>
                        <input 
                            type="number" 
                            id="carga_horaria"
                    ...
                    <!-- Gestión -->
                    <div>
                        <label for="gestion_default" class="block text-sm font-medium mb-2 text-gray-900 dark:text-white">
                            Gestión <span class="text-red-500">*</span>
                        </label>
                        <input 
                            type="text" 
                            id="gestion_default"
                            wire:model="gestion_default"
                            placeholder="2-2025"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition
                                {{ $errors->has('gestion_default') 
                                    ? 'border-red-500 dark:border-red-500' 
                                    : 'border-gray-300 dark:border-gray-700' }}
                                bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400">
                        @error('gestion_default')
                            <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                </div>
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-yellow-700 dark:text-yellow-400">
                    Al modificar el código o nombre de una materia, verifica que no afecte a grupos o horarios ya asignados.
                </p>
            </div>
        </div>
    </div>
