<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nueva Materia</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Registra una nueva materia en el sistema</p>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-blue-700 dark:text-blue-400">
                    El código debe ser único. La carga horaria típica es entre 40 y 120 horas.
                </p>
            </div>
        </div>
    </div>
