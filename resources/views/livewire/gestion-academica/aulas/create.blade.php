<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nueva Aula</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Registra una nueva aula en el sistema</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            max="500"
                            class="w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition
                                {{ $errors->has('capacidad') ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-700' }}
                                bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400">
                        @error('capacidad')
                            <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-blue-700 dark:text-blue-400">
                    El código debe ser único. La capacidad promedio de un aula es entre 20 y 50 personas.
                </p>
            </div>
        </div>
    </div>
