<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar Grupo</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Modifica los datos del grupo</p>
        </div>
    ...
    <div class="rounded-lg border border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-900/20 p-4">
        <div class="flex gap-3">
            ...
            <div>
                <p class="text-sm font-medium text-yellow-800 dark:text-yellow-300">{{__('Advertencia')}}</p>
                <p class="mt-1 text-sm text-yellow-700 dark:text-yellow-400">
                    {{__('Al modificar el código o la materia de un grupo, verifica que no afecte a horarios ya asignados.')}}
                </p>
            </div>
        </div>
    </div>
