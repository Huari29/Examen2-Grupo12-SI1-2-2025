                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse ($grupos as $grupo)
                        <tr class="bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <button wire:click="toggleActivo({{ $grupo->id_grupo }})"
                                    class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold transition
                                        {{ $grupo->activo ? 'bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-300' }}">
