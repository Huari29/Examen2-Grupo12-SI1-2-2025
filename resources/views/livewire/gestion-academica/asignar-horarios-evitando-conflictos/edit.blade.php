<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar Asignación</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Modifica la asignación de docente, materia y grupo</p>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-yellow-700 dark:text-yellow-400">
                    Al modificar esta asignación, puede afectar los horarios ya creados para este grupo.
                </p>
            </div>
        </div>
    </div>
