<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Gestionar Horarios</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Define los bloques de tiempo disponibles para asignar clases</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full bg-white dark:bg-gray-900">
                <thead class="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <tr>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-200">ID</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-200">Hora Inicio</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-200">Hora Fin</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-200">Duración</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-200">Creado</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse ($horarios as $horario)
                        <tr class="bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300">
                                    #{{ $horario->id }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300">
                                    @php
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ $horario->creado_en->format('d/m/Y H:i') }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <button wire:click="confirmDelete({{ $horario->id }})"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">No se encontraron horarios</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">¿Eliminar Horario?</h3>
