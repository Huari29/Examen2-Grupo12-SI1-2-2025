...
<head>
    ...
    <title>Horario Aula - {{ $aula->codigo }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="info-section">
        <span class="info-item">
            <span class="info-label">Aula:</span> {{ $aula->codigo }} - {{ $aula->nombre }}
        </span>
        <span class="info-item">
            <span class="info-label">Capacidad:</span> {{ $aula->capacidad }} estudiantes
        </span>
        <span class="info-item">
                        ...
                        <td>
                            @if(isset($horarioOrganizado[$dia][$horario->id]))
                                ...
                                <div class="clase-info">
                                    ...
                                    <div class="docente">{{ $detalle->materiaGrupo->docente->nombre }}</div>
                                </div>
                            @else
